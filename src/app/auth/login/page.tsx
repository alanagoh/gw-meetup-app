    ...
    <div className="flex flex-col items-center justify-center min-h-dvh px-6">
      ...
      <div className="w-full max-w-sm space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#24292f] text-white font-semibold rounded-xl hover:bg-[#2f363d] active:scale-[0.98] transition-all disabled:opacity-50 disabled:scale-100"
        >
